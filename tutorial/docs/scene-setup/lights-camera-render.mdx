...
:::tip Picking a background color
...
When you start a new project, pick a background color, even if you intend to have a black background in the finished scene.
:::
