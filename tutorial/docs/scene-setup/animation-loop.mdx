...
updates, or _refreshes_, the image on your display. Programs can attach
...
often this happens is referred to as the _refresh rate_. You may have seen this
...
The _frame rate_ of your animation is how many times your animation updates each
...
When the browser calls the function, it passes a single parameter to it that
...
In fact, all the code you've assembled so far can be used with other projects
as-is.
