...
Many tutorials exist that provide a quick how-to demonstration for a particular technology. There are also many tutorials about how to build a copy of an existing work. Both types are useful, but neither provides a structured platform for continued learning and experimentation.
...
This tutorial is for anyone who wants to use programming as a way to create visual expressions and who has some experience with JavaScript. This tutorial will not teach you how to program, and if you are completely new to programming, you should complete an introductory tutorial first. If you are unsure, you should be familiar with concepts such as variables, types, arrays, objects, loops, `if` statements, and functions. You will find links to introductory JavaScript tutorials in the ["Additional resources"](#learning-javascript) section below.

If you are an experienced JavaScript developer, you may still find this tutorial to be a helpful introduction to three.js. Keep in mind, however, that the code is structured towards helping those with less programming experience experiment with 3D graphics.
