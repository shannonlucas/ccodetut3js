...
Consider how many cells tall and wide the grid is; this will be the grid's "size." You'll also need to know the size the cells should be, and finally, the spacing between the cells.
