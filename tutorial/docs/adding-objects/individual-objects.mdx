...
If you'd like to know more about vectors, you can find links to learning resources in the [Additional resources](./../wrapping-up/additional-resources.mdx) section.
