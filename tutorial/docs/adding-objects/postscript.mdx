...
* Consider the logic that determines where to place the camera:
  ...
  How might you modify the `setUpLights` function so that the position of the lights is determined by the size of your rotating grid? What happens if you accidentally place one of your lights inside the grid? _**Note**: this is an advanced exercise_.
