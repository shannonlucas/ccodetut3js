...
scene. You created the `scene` variable in the [previous module][M1TOGETHER].
...
If you ran your code right now, you wouldn't see anything. The camera you created in the [previous module][M1CAMERA] is located at its default location: (0, 0, 0), and it was set to "look at" the position (0, 0, 0) as well. This means that at the moment all the cells you just created are out of view.
...
[POSTSCRIPT]: ./postscript.mdx#additional-resources
[M1TOGETHER]: ./../scene-setup/put-it-together.mdx
[M1CAMERA]: ../scene-setup/lights-camera-render.mdx#adding-the-camera
